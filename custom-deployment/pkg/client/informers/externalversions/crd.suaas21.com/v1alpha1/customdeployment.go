...
import (
	...
	crdsuaas21comv1alpha1 "github.com/suaas21/go-practice/custom-deployment/pkg/apis/crd.suaas21.com/v1alpha1"
	versioned "github.com/suaas21/go-practice/custom-deployment/pkg/client/clientset/versioned"
	internalinterfaces "github.com/suaas21/go-practice/custom-deployment/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/suaas21/go-practice/custom-deployment/pkg/client/listers/crd.suaas21.com/v1alpha1"
...
func NewFilteredCustomDeploymentInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&crdsuaas21comv1alpha1.CustomDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *customDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdsuaas21comv1alpha1.CustomDeployment{}, f.defaultInformer)
}
